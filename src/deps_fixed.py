...
if credentials_path:
    ...
    logger.warning("No service account file found in any of the expected locations")
    logger.warning("Expected locations: GOOGLE_APPLICATION_CREDENTIALS env var, ./service-account.json, /app/service-account.json")
